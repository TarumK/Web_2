...
class UserForm(forms.Form):
    name = forms.CharField(label = "Имя клиента", initial="Murat")
    age = forms.IntegerField(label = "Возраст клиента", initial="20")
    ...
    comment = forms.CharField(label="Koммeнтapий", widget= forms.Textarea)